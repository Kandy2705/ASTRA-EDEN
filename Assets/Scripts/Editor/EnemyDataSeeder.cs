...
public static class EnemyDataSeeder
{
    ...
    static readonly EnemyRow[] Enemies = new[]
    {
        Enemy("enemy_wild_claw_raptor",           "Wild Claw Raptor",             EnemyArchetype.Melee,         EnemyRank.Normal, EnemyZone.BeachCrash,
            350,  45, 20,  40, 4.2f, 720, 14, 110,  7, 24, 2.0f, 1.8f,  25,  8, 14, "loot_raptor_basic",      "atk_raptor_bite", "atk_raptor_claw_combo"),
        Enemy("enemy_scavenger_lizard",           "Scavenger Lizard",             EnemyArchetype.Fast,          EnemyRank.Normal, EnemyZone.BeachCrash,
            220,  30, 12,  25, 4.8f, 760, 12, 100,  8, 20, 1.5f, 1.4f,  18,  5, 10, "loot_lizard_basic",      "atk_raptor_bite"),
        Enemy("enemy_young_spitter",              "Young Spitter",                EnemyArchetype.Ranged,        EnemyRank.Normal, EnemyZone.BeachCrash,
            280,  38, 15,  25, 3.2f, 600, 16, 120,  6, 26, 9.0f, 2.8f,  28,  8, 16, "loot_spitter_basic",     "atk_spitter_acid_spit"),
        Enemy("enemy_driftback_boarlizard",       "Driftback Boar-Lizard",        EnemyArchetype.Tanker,        EnemyRank.Normal, EnemyZone.BeachCrash,
            550,  55, 45,  80, 2.8f, 420, 12, 100,  7, 22, 2.4f, 2.4f,  40, 14, 24, "loot_tanker_basic",      "atk_tanker_head_slam", "atk_tanker_body_shove"),
        Enemy("enemy_beach_parasite",             "Beach Parasite",               EnemyArchetype.Debuff,        EnemyRank.Normal, EnemyZone.BeachCrash,
            180,  25,  8,  15, 3.8f, 650, 10, 100,  6, 18, 1.6f, 2.0f,  15,  4,  8, "loot_parasite_basic",    "atk_raptor_bite"),
        Enemy("enemy_fang_raptor",                "Fang Raptor",                  EnemyArchetype.Fast,          EnemyRank.Normal, EnemyZone.PrimevalForest,
            420,  60, 25,  35, 5.4f, 820, 16, 115,  8, 28, 1.8f, 1.5f,  40, 12, 20, "loot_raptor_forest",     "atk_raptor_leap_bite", "atk_raptor_bite"),
        Enemy("enemy_raptor_pack_leader",         "Wild Claw Raptor Pack Leader", EnemyArchetype.Melee,         EnemyRank.Elite,  EnemyZone.PrimevalForest,
            900,  75, 40,  75, 4.5f, 720, 18, 120, 10, 30, 2.2f, 1.8f,  90, 30, 55, "loot_pack_leader",       "atk_raptor_claw_combo", "atk_elite_roar"),
        Enemy("enemy_armored_herbivore_juvenile", "Armored Herbivore Juvenile",   EnemyArchetype.Tanker,        EnemyRank.Normal, EnemyZone.PrimevalForest,
            800,  65, 60, 110, 2.6f, 380, 12, 100,  7, 24, 2.6f, 2.8f,  60, 20, 36, "loot_armored_herbivore", "atk_tanker_head_slam", "atk_tanker_body_shove"),
        Enemy("enemy_crystal_screecher",          "Crystal Screecher",            EnemyArchetype.CasterSupport, EnemyRank.Normal, EnemyZone.PrimevalForest,
            360,  50, 20,  30, 3.0f, 550, 17, 130,  8, 28,10.0f, 3.5f,  55, 16, 28, "loot_crystal_caster",    "atk_caster_crystal_shard", "atk_caster_buff_roar"),
        Enemy("enemy_poison_mire_spitter",        "Poison Mire Spitter",          EnemyArchetype.Ranged,        EnemyRank.Normal, EnemyZone.PrimevalForest,
            480,  65, 22,  35, 3.1f, 600, 18, 125,  7, 30,10.5f, 2.7f,  58, 18, 32, "loot_spitter_poison",    "atk_spitter_acid_spit", "atk_spitter_acid_pool"),
        Enemy("enemy_corrupted_lab_raptor",       "Corrupted Lab Raptor",         EnemyArchetype.Melee,         EnemyRank.Normal, EnemyZone.RuinedLab,
            620,  80, 35,  55, 4.4f, 720, 15, 115,  8, 28, 2.0f, 1.7f,  70, 22, 40, "loot_corrupted_raptor",  "atk_raptor_claw_combo", "atk_raptor_bite"),
        Enemy("enemy_core_spitter",               "Core Spitter",                 EnemyArchetype.Ranged,        EnemyRank.Normal, EnemyZone.RuinedLab,
            560,  78, 30,  40, 3.0f, 580, 18, 125,  7, 30,11.0f, 2.6f,  72, 24, 42, "loot_core_spitter",      "atk_spitter_acid_spit"),
        Enemy("enemy_security_warden_dronebeast", "Security Warden Drone-Beast",  EnemyArchetype.CasterSupport, EnemyRank.Elite,  EnemyZone.RuinedLab,
            850,  70, 50,  80, 3.4f, 620, 18, 140,  8, 30, 9.0f, 3.2f, 110, 38, 65, "loot_warden_elite",      "atk_caster_crystal_shard", "atk_elite_roar"),
        Enemy("enemy_flux_hound",                 "Flux Hound",                   EnemyArchetype.Fast,          EnemyRank.Normal, EnemyZone.RuinedLab,
            520,  82, 25,  32, 5.8f, 850, 16, 115,  9, 30, 1.7f, 1.3f,  68, 22, 38, "loot_flux_hound",        "atk_raptor_leap_bite", "atk_raptor_bite"),
        Enemy("enemy_core_corrupted_raptor",      "Core Corrupted Raptor",        EnemyArchetype.Melee,         EnemyRank.Normal, EnemyZone.CrystalCore,
            760,  95, 45,  65, 4.6f, 740, 17, 120,  8, 32, 2.0f, 1.6f,  90, 32, 55, "loot_core_corrupted",    "atk_raptor_claw_combo", "atk_raptor_bite"),
        Enemy("enemy_prism_screecher",            "Prism Screecher",              EnemyArchetype.CasterSupport, EnemyRank.Elite,  EnemyZone.CrystalCore,
            950,  88, 45,  70, 3.2f, 600, 20, 145,  9, 34,11.0f, 3.2f, 130, 45, 80, "loot_prism_screecher",   "atk_caster_crystal_shard", "atk_caster_buff_roar", "atk_elite_roar"),
        Enemy("enemy_crystal_shell_brute",        "Crystal Shell Brute",          EnemyArchetype.Tanker,        EnemyRank.Elite,  EnemyZone.CrystalCore,
            1400,105, 80, 150, 2.5f, 360, 14, 110,  7, 30, 3.0f, 2.8f, 150, 55, 95, "loot_crystal_brute",     "atk_tanker_head_slam", "atk_elite_charge"),
    };
